...
## OVERVIEW
This is an intelligent traffic management solution designed to prioritize and navigate emergency vehicles through desnse traffic using V2X Technology and thus reduce emergency response times. It uses V2I (Vehicle-to-Infrastructure) to preempt traffic lights and V2V (Vehicle-to-Vehicle) to alert surrounding drivers.
## SYSTEM ARCHITECTURE
